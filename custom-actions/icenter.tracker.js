 ...
 */
 ...
 (function(){
    ...
    var SiteCollectionURL = origin + '/sites/peess/main/Wil/TaskTracker';
    ...
    function VarifyUser(response){
        ...
        EDIPI_ACCESS_TOKENS.forEach(function(loginname){
            if (loginname === LoginName) return UserHasAccess = loginname;
        });
    ...
    document.addEventListener('DOMContentLoaded', function DOMContentLoaded(event){
        ...
        // return GET(LoginNamePath, console.info);
