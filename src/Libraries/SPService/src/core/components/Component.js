...
export default class Component {
    ...
    constructor(arg) {
        ...
        if (!arg) throw new Error(`${title} | Invalid request, argument is invalid!`);
    ...
    get(arg){
        ...
        else throw new Error(`${title} | The argument passed was invalid!`);
    }
    ...
    prepend(element){
        ...
        if (!element) throw new Error(`${title} | Invalid request, argument is invalid type!`);
