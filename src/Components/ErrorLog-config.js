...
(function(showConsoleButton = false){
    ...
    var ReportErrors = function ReportErrors() {
        ...
        windowConsole.document.write(/*html*/`<img style="width: 12em;" src="./src/images/SAIC/4_White/SAIC-Logo-RGB-White-sm.png" />`);
        windowConsole.document.write(/*html*/`
        <div style="margin: 0px 19px;">
            <svg class="bi bi-terminal" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="height:24px;width:24px;"><path d="M6 9a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3A.5.5 0 0 1 6 9zM3.854 4.146a.5.5 0 1 0-.708.708L4.793 6.5 3.146 8.146a.5.5 0 1 0 .708.708l2-2a.5.5 0 0 0 0-.708l-2-2z"></path><path d="M2 1a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2H2zm12 1a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h12z"></path></svg>
        </div>
        <h3 style="margin: 0px 19px;">Error Console</h3>`);
