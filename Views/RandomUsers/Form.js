    ...
    form = new Form({
        ...
        <div class="row g-3 my-2">
            <div class="col-xl-5 col-lg-6 col-sm-12">
                <label for="inputRandomUsersTitle" class="form-label">RandomUsers Title</label>
                <input type="text" name="RandomUsersTitle" class="form-control form-control-sm" id="inputRandomUsersTitle" required />
