/**
 * @title Post.js
 * @description Post event for Branches list items
...
export default function Post(event){
    ...
    .done(function RequestComplete(data, textStatus, xhr){
        ...
        {            
            ...
            // TODO: This is where you would make the call back before claiming its a success;
            // TODO: The call back is to create steps if any;
            // TODO: You need the GUID for the steps request, it is the FK;
            console.info(data.d.GUID);
