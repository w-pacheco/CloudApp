...
export const Icon = 'geo-alt-fill';
export const th = [{
    thead: 'Id',
    col: {
        data: 'Id',
...
export function getMarkets(){
    return Route.Get(Web.getListDetails(Title).__metadata.uri + '/Items', {
        $select: '*',
        $filter: `LocationType eq 'Market' and Display eq 'Yes'`,
    })
    .then(data => data.d.results)
}

/** Admin View Method; */
export function LocationsTab(menu, tabcontent){
