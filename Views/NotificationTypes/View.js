 ...
 */
export const Icon = 'envelope-exclamation';
export const th = [{
    thead: 'Id',
    col: {
        data: 'Id',
...
/** Admin View Method; */
export function NotificationTypesTab(menu, tabcontent){
...
export default function NotificationTypes(){
    ...
    table = new Table({
        ...
        parent: container.get(),
        buttons: [{
            // TODO: Add roles reference to the buttons if they are locked down;
            icon: 'plus',
            events: [{ 
                name: 'click', 
                action(event){
