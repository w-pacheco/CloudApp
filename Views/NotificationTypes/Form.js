/**
 * Form.js
 * @description NotificationTypes Form
    ...
    form = new Form({
        ...
        <div class="row my-2">
            <div class="col-lg-4 col-md-12">
                ...
                <input type="text" id="inputValue" name="Value" class="form-control" required>
            </div>
        </div>
        <div class="row my-2">
            <div class="col-lg-12">
                <p class="form-label">Description<small class="text-muted"></small></p>
                <textarea class="border rounded form-control" rows="2" id="inputDescription" name="Description" required></textarea>
            </div>
        </div>
        `,
    }).render();
